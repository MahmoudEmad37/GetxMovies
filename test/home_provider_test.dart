...
void main() {
  ...
  group('getTopRatedMovies', () {
    test('getTopRatedMovies', () async {
      final mockTopRatedMovie = AllMoviesResponseModel(topRatedMovies: [
        MovieModel(
          adult: false,
      ...
      when(() => mockHttpClient.get(Endpoints.kGetTopRatedMovie,
      ...
      expect(result!.topRatedMovies,
          isA<List<MovieModel>>().having((movie) => movie[0].id, "id", 101));
    });

    test('getTopRatedMovies error', () async {
      ...
      expect(newsModel, throwsA(isA<NetworkException>()));
    });
  });
}
