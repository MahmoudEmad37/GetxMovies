                                ...
                                children: [
                                  infoRowWidget(
                                      ...
                                      state?.genres
                                              ...
                                              .join(', ') ??
                                          ""),
                                  infoRowWidget(LocalKeys.released.tr,
                                      state?.releaseDate ?? ""),
                                  infoRowWidget(LocalKeys.runtime.tr,
                                      "${state?.runtime} ${LocalKeys.minutes.tr}"),
                                  infoRowWidget(LocalKeys.budget.tr,
                                      "\$${state?.budget.toString()}"),
                                  infoRowWidget(LocalKeys.revenue.tr,
                                      "\$${state?.revenue.toString()}"),
                                  infoRowWidget(LocalKeys.rating.tr,
